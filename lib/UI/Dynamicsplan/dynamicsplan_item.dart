...
import 'package:sitearound/UI/Dynamicsplan/dynamicsplan_info.dart';
import 'package:sitearound/ulility/style.dart';
import 'package:sitearound/ulility/text_style.dart';

class DynamicsPlanItems extends StatefulWidget {
  @override
  _DynamicsPlanItemsState createState() => _DynamicsPlanItemsState();
}

class _DynamicsPlanItemsState extends State<DynamicsPlanItems> {
  ...
  Future<DynamicModel> getDynamicPlanList() async {
    ...
    var result = await client.get(
      endpoints.dynamicPlanListItem.replaceAll(
        ':project_name',
