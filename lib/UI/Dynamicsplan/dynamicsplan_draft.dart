...
class DynamicsPlanDraft extends StatefulWidget {
  @override
  _DynamicsPlanDraftState createState() => _DynamicsPlanDraftState();
}

class _DynamicsPlanDraftState extends State<DynamicsPlanDraft> {
  ...
  Future<DynamicModel> getDynamicPlanList() async {
    ...
    var result = await client.get(
      endpoints.dynamicPlanListDraft.replaceAll(
        ':project_name',
