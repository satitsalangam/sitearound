...
class SubmittalRecycleBin extends StatefulWidget {
  @override
  _SubmittalRecycleBinState createState() => _SubmittalRecycleBinState();
}

class _SubmittalRecycleBinState extends State<SubmittalRecycleBin> {
  ...
  Future<SumittalModel> getSubmittalList() async {
    ...
    var result = await client.get(
      endpoints.submittalListRecycleBin.replaceAll(
        ':project_name',
