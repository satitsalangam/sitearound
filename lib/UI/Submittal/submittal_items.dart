...
class SubmittalItem extends StatefulWidget {
  @override
  _SubmittalItemState createState() => _SubmittalItemState();
}

class _SubmittalItemState extends State<SubmittalItem> {
  ...
  Future<SumittalModel> getSubmittalList() async {
    ...
    var result = await client.get(
      endpoints.submittalListItem.replaceAll(
        ':project_name',
