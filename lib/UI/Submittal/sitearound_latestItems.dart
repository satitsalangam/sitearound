...
class SitearoundLatestItems extends StatefulWidget {
  @override
  _SitearoundLatestItemsState createState() => _SitearoundLatestItemsState();
}

class _SitearoundLatestItemsState extends State<SitearoundLatestItems> {
  ...
  Future<SumittalModel> getSubmittalList() async {
    ...
    var result = await client.get(
      endpoints.submittalListLatestItems.replaceAll(
        ':project_name',
