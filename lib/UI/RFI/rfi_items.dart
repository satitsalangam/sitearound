...
class RFIItems extends StatefulWidget {
  @override
  _RFIItemsState createState() => _RFIItemsState();
}

class _RFIItemsState extends State<RFIItems> {
  ...
  Future<RfiModel> getRFIList() async {
    ...
    var result = await client.get(
      endpoints.rfiListItem.replaceAll(
        ':project_name',
