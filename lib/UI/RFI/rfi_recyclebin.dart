...
class RFIRecycleBin extends StatefulWidget {
  @override
  _RFIRecycleBinState createState() => _RFIRecycleBinState();
}

class _RFIRecycleBinState extends State<RFIRecycleBin> {
  ...
  Future<RfiModel> getRFIList() async {
    ...
    var result = await client.get(
      endpoints.rfiListRecycleBin.replaceAll(
        ':project_name',
